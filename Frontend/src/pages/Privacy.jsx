  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-16 text-slate-800 leading-relaxed">
      ...
      <p>
        ...
        items. This may include internal identifiers, file attributes, storage
      ...
      <ul className="list-disc pl-6 mt-3">
        <li>Providing secure file storage and access</li>
        <li>Enabling vault protection and recovery features</li>
        <li>Operating public sharing and content delivery</li>
        <li>Displaying advertisements on public pages</li>
        <li>Processing payments and optional upgrades</li>
        <li>Preventing abuse, fraud, and security risks</li>
        <li>Enforcing platform policies and copyright rules</li>
        <li>Complying with legal obligations</li>
        <li>Maintaining and improving platform performance</li>
      </ul>
      ...
      <h2 className="font-semibold text-xl mt-10 mb-3">4. Public Links & Sharing</h2>

      <p>
        Content shared using public links may be accessed by anyone with the
        link. To ensure reliability, performance, and protection against misuse,
        public access activity may be processed and analyzed. Public pages may
        display advertising or third-party content.
      </p>
      ...
      <h2 className="font-semibold text-xl mt-10 mb-3">6. Data Retention</h2>

      <p>
        Information and files may be retained for operational, legal, security,
        or backup purposes, including after deletion, in accordance with
      ...
      <h2 className="font-semibold text-xl mt-10 mb-3">8. Your Control</h2>
