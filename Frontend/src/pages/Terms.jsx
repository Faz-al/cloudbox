export default function Terms() {
  return (
    <div className="max-w-4xl mx-auto px-6 py-16 text-slate-800 leading-relaxed">
      ...
      <h2 className="font-semibold text-xl mt-10 mb-3">2. Your Files and Content</h2>
      ...
      <ul className="list-disc pl-6 mt-3">
        ...
        <li>Content involving child exploitation</li>
        <li>Material that promotes violence, terrorism, or hate</li>
        <li>Content that infringes on privacy or intellectual property</li>
      </ul>

      <h2 className="font-semibold text-xl mt-10 mb-3">4. Public Sharing</h2>
